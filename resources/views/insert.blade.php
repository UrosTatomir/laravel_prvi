...
<body style="background:linear-gradient(to top,#FFFFF,white)no-repeat fixed center;">
    ...
    <div class="container-fluid text-center">
        <div class="container col-10 mt-5 mb-5 p-3">
            <h1><a class="text-danger" href="#">Insert driver</a></h1>

            <form action="/insert_new_driver">
                <div class="form-group p-3">
                    <label for="name">Name</label>
                    <!-- nacin na koji se prikazuje greska  u laravelu-->
                    @if ($errors->any())
                    ...
                    <br>
                    <input type="submit" class="btn btn-warning" value="Insert Driver">
                </div>
            </form>
        </div>
