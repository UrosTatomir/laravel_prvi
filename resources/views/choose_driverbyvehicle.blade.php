...
<head>
    ...
    <title>Assign Driver & Vehicles</title>
...
<body style="background:linear-gradient(to top,#FFFFF,white)no-repeat fixed center;">
    ...
    <nav class="navbar fixed-top navbar-expand-lg  navbar-dark bg-dark ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="links">
                ...
                <a href="{{url('/choose_vehiclebydriver')}}">ChooseVehicleByDrivers</a>
            </div>
            &nbsp; &nbsp;
    ...
    <div class="container-fluid text-center">
        ...
        <div class="container col-8 mt-5 mb-5 p-3">
            <h3><a class="text-danger" href="#">Choose driver by vehicles</a></h3>
            <form action="/choose_drivers">
                @if ($errors->any())
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="id_driver">
                        ...
                        ?>
                        @foreach($alldrivers as $p)
                        <option value="{{$p->id_driver}}">{{$p->name}}, {{$p->surname}}, {{$p->age}}</option>

                        @endforeach
                    </select>
                    <br>
                    <input type="submit" class="btn btn-warning" value="Choose driver">
                </div>
            </form>
        </div>
    </div>
