...
<body style="background:linear-gradient(to top,#FFFFF,white)no-repeat fixed center;">
    ...
    <div class="container-fluid text-center">
        <div class="container col-8 mt-5 mb-5 p-3">
            <h1><a class="text-danger" href="#">Insert Vehicle</a></h1>
            <form action="/insert_car">
                @if ($errors->any())
                ...
                <div class="form-group">
                    <label for="imepro">Enter the vehicle brand</label>
                    <br>
                    ...
                    <br>
                    <label>Enter the vehicle category</label>

                    <select class="form-control col-2" name="category">
                        <option value=""></option>
                        <?php
                    ...
                    <br>
                    <input type="number" name="year_vehicle" class="form-control" placeholder="Enter the production year">
                    <br>

                    <input type="number" name="price" class="form-control" placeholder="Enter the price">
                    <br>

                    <input type="submit" class="btn btn-warning" value="insert_car">
                </div>
            </form>
    ...
    <div class="card-body">
        <h4>You are not logged in please , <a href="{{ route('login') }}">login</a>, or <a href="{{route('register')}}">register</a></h4>
    </div>
    </div>
    @endif
</body>
