...
<body style="background:linear-gradient(to top,#FFFFF,white)no-repeat fixed center;">
    ...
    <nav class="navbar fixed-top navbar-expand-lg  navbar-dark bg-dark ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="links">
                ...
                <a href="{{url('/allvehicle')}}">All vehicles</a>
    ...
    <div class="container-fluid text-center">
        <div class="container col-8 mt-5 mb-5 p-3">
            <h1><a class="text-danger" href="#">Edit vehicle</a></h1>
            <form action="/edit_vehicle">
                @if ($errors->any())
                ...
                <div class="form-group">
                    @foreach($one_vehicle as $value)
                    <input type="hidden" class="form-control" name="id_vehicle" value="{{$value->id_vehicle}}">
                    ...
                    <input type="text" class="form-control" name="brand" value="{{$value->brand}}">
                    ...
                    <br>
                    <input type="number" class="form-control" name="year_vehicle" value="{{$value->year_vehicle}}">
                    <br>
                    <input type="text" class="form-control" name="price" value="{{$value->price}}">

                    <br>
                    <input type="submit" class="btn btn-warning" value="Edit Vehicle"><br>
                    @endforeach
                </div>
            </form>
