...
<body style="background:linear-gradient(to top,#FFFFF,white)no-repeat fixed center;">
    ...
    <nav class="navbar fixed-top navbar-expand-lg  navbar-dark bg-dark ">
        <a class="navbar-brand" href="{{url('/welcome')}}" style="font-family: cursive, sans-serif; font-size:18px; color: #FDE600;">
            Welcome</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <!-- <li class="nav-item active">
                    <a class="nav-link" href="{{url('/insert')}}">Insert<span class="sr-only">(current)</span></a>
                </li> -->
                @if (!empty($success))
                <li class="nav-link">{{$success}}</li>
                @endif
            </ul>
            <div class="links">
                ...
                <a href="{{url('/show_allvehicle')}}">All vehicle</a>
    ...
    <div class="container-fluid text-center">
        <div class="row justify-content-md">
            ...
            <img src="{{url('/images/johanunsplash.jpg')}}" class="card-img" width="1280" alt="card image" />
        </div>
